...
class M1 extends Template {
   ...
   @Override
   int apply(int i) {
      return i; // For M1, just return the number itself, as the sum is of the numbers.
   }
}
...
class M2 extends Template {
   ...
   @Override
   int apply(int i) {
      return i * i; // For M2, return the square of the number, as the sum is of the squares.
   }
}
